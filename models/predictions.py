...
from utils.datasets import ClfDataset, SortedSampler, ClfCollate_withFeatures
from utils.load_embeddings import load_word_vectors_from_fasttext, load_word_vectors
from utils.opts import train_options
from utils.training import load_checkpoint, acc, f1_macro

os.environ["CUDA_VISIBLE_DEVICES"] = "0"

def process_batch_test(model, src, labels, features, lengths):
    logits, representations, attentions = model(src, features, lengths)
...
yaml = os.path.join(psych_yamls,"concat.yaml")
...
checkpoint_name = "Psych_exp_concat"
