...
def clf_baseline_runner(yaml, word2idx, idx2word, weights, cluster=False):
    if cluster is False:
    ...
    if config["data"]["dataset"] == "scv2_gen":
        name_train = "scv2_train"
        name_val = "scv2_val"
    elif config["data"]["dataset"] == "scv1":
        name_train = "scv1_train"
        name_val = "scv1_val"
    elif config["data"]["dataset"] == "psych_exp":
        name_train = "psych_train"
        name_val = "psych_val"
    else:
        name_train = None
        name_val = None
    ...
    # train_set.truncate(5000)
    # val_set.truncate(500)
